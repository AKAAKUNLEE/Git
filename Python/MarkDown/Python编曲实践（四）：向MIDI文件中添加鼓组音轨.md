...
在前面三篇文章中，我介绍了如何通过[Python](https://so.csdn.net/so/search?q=Python&spm=1001.2101.3001.7020)的Mido库添加旋律、和弦和模拟滑音、颤音。然而，鼓的作用也是不可忽视的，它就像骨骼一样支撑起整个音乐，而编辑鼓点的样式也为想象力的发挥提供了无限空间，是十分愉悦的事情，本篇文章我就介绍如何向MIDI文件中添加鼓的音轨。
