...
create_folder_label.grid(row=3, column=0, pady=5, sticky="w")

create_folder_entry = ttk.Entry(page2, width=20)
create_folder_entry.grid(row=3, column=1, padx=5, sticky="w")

create_folder_button = ttk.Button(page2, text="新建文件夹", command=lambda: create_folder(directory_entry, create_folder_entry))
create_folder_button.grid(row=3, column=2, pady=5, sticky="w")
